...
function SignupForm() {
  ...
  return (
    <div className="relative">
      {didSignup && (
        <div
          className={`text-lg text-gray-8 font-medium ${
        ...
        >
          <div className="md:inline-flex md:shadow-black">
            <input
              ...
              className="form-input bg-white text-gray-xx800 w-full rounded px-5 py-3 border-2 border-transparent focus:shadow-none focus:border-green-700 md:border-r-0 md:rounded-r-none md:w-96"
            />
